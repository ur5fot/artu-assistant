...
- [ ] **Step 1: Обновить `packages/shared/src/types.ts`**
...
- [ ] **Step 3: Typecheck server (shared types используются везде)**
...
- [ ] **Step 1: Создать `routes/memory-confirm.ts`**
...
- [ ] **Step 2: Создать service (по образцу plan-review-service)**
...
- [ ] **Step 3: Failing тесты для service**
...
- [ ] **Step 5: Requester в tool-helpers**
...
- [ ] **Step 6: Прокинуть через tool-loop и router**
