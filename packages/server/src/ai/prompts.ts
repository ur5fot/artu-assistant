...
ПОГОДА / ЦІНИ / КУРСИ — 2-ETAPHI TOOL CHAIN:
...
Якщо юзер просить конкретні цифри (температура завтра, курс валют, ціна акції):
  1) web_search → отримай релевантні URL
  2) web_fetch один з URL → отримай повний текст сторінки
  3) витягни число з тексту і відповідай коротко
Якщо зробив лише web_search і кажеш "не можу прочитати" — це означає що ти забув крок 2. Виклич web_fetch.
