...
| /активність | activity | Зведення активності за компом (застосунки/сайти/час/зміни/відволікання) за період today/yesterday/last_24h — read-only over `window_history` + `distraction_evals`, gated `WINDOW_LOGGER_ENABLED` |
