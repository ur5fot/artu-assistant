...
REDELIVER_MAX_AGE_MS=21600000     # max age (ms) of an undelivered cognition publish run still re-delivered on Discord (re)connect/restart; default 6h, clamp 5m..48h
```
